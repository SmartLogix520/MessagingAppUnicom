      ...
      <div clas="w-full bg-transparent " >
        <div>
          ...
          <div class=" flex bg-white">
            ...
            <p className='unicom' style={{ fontWeight: 'bold', color: '#628ecb', marginLeft: '76px', marginTop:'px',fontSize: '30px' }}>
  UniCom
</p>

              <img class="w-full" src={logo} className="p-3 logo"style={{ width: '110px', height: 'auto' ,marginTop:'-75px', marginLeft: '-20px',position:'fixed'}} />
           
            </div>
            </div>
            {/* <div class=" cole w-4/6 pt-1">
              <input
                class="my-9 w-full shadow appearance-none border border-slate-200 rounded py-2 px-3 text-gray-700 mb-2 leading-tight focus:outline-none focus:shadow-outline bg-slate-50"
                id="password"
                type="Text"
